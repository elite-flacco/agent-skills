...
2. If the change affects documented behavior, update `README.md` before committing.
...
8. If multiple distinct changes are detected, suggest breaking the commit into smaller commits (see Guidelines for Splitting below) and ask the user to confirm. ONLY split the changes into multiple commits if the user confirms. Otherwise, proceed to step 9.
